...
show_menu_header() { set +x 2>/dev/null
  ...
  printf "  ${D}──────────────────────────────────────────────────────────────────────────────────${R}\n"
  printf "  ${D}commands:${R}\n"
  printf "  ${D}10  aliases        20  deb           30  monitors       40  quick-cmds    50  help${R}\n"
  printf "  ${D}11  webhooks       20a nix-cli      30a btop           40a gcp-proxy    51  tools${R}\n"
  printf "  ${D}12  commands       20b nix-gui      30b iotop          40b oci-mail     51a table${R}\n"
  printf "  ${D}  120 fish-install  20c nix-tty      30c top-batch      40c oci-analy    51b help${R}\n"
  printf "  ${D}  121 flush-ipt    20d apt-cli      31  sysstat        40d oci-apps     52  info${R}\n"
  printf "  ${D}  122 rst-sshd     20e apt-gui      31a iostat         40e gcp-t4       52a info${R}\n"
  printf "  ${D}  123 rst-wg       20f apt-tty      31b mpstat         40f orchestrate  52b engines${R}\n"
  printf "  ${D}  124 rst-docker   21  nixos        31c pidstat        40g local${R}\n"
  printf "  ${D}  125 stop-docker  21a hm-cli       31d sar            40h desktop${R}\n"
  printf "  ${D}  126 start-docker 21b hm-gui       32  journal-dash   40i vps-cloud${R}\n"
  printf "  ${D}  127 docker-ps    21c hm-tty       32a transport      40j gh-actions${R}\n"
  printf "  ${D}  128 wg-status    22  shell        32b priority       40k gh-repos${R}\n"
  printf "  ${D}  129 iptables     22a fish+tools   32c unit           40l gh-registry${R}\n"
  printf "  ${D}  1210 free-mem    22b fish         32d watch-n35      41  ssh${R}\n"
  printf "  ${D}  1211 disk-usage  22c konsole-cfg  33  connect        41a gcp-proxy${R}\n"
  printf "  ${D}  1212 kill-wdog   23  git          34  btop-dash      41b oci-mail${R}\n"
  printf "  ${D}  1213 journal-sil 23a gcl-https    35  journal-dash   41c oci-analy${R}\n"
  printf "  ${D}  1214 fix-journal 23b gcl-ssh      36  docker-stats   41d oci-apps${R}\n"
  printf "  ${D}  1215 full-rescue                                     41e gcp-t4${R}\n"
  printf "  ${D}  1216 tmux-web                                        41f github${R}\n"
  printf "  ${D}  1217 fix-wg-ip${R}\n"
  printf "  ${D}  1218 guardrail${R}\n"
  printf "  ${D}  1219 fix-nix-path${R}\n"
  printf "  ${D}  1220 ssh-restart${R}\n"
  printf "  ${D}  1221 wg-debug${R}\n"
  printf "  ${D}  1222 sshd-debug${R}\n"
  printf "  ${D}  1223 vm-health${R}\n"
  printf "  ${D}  1224 fix-all${R}\n"
