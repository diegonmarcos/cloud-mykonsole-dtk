...
show_menu_header() { set +x 2>/dev/null
  ...
  printf "  ${D}──────────────────────────────────────────────────────────────────────────────────${R}\n"
  printf "  ${Y}10${R} ${D}aliases${R}         ${Y}30${R} ${D}monitors${R}        ${Y}40${R}  ${D}quick-cmds${R}      ${Y}50${R} ${D}help${R}\n"
  printf "  ${Y}11${R} ${D}tools${R}           ${Y}30a${R} ${D}btop${R}           ${Y}40a${R} ${D}gcp-proxy${R}      ${Y}51${R} ${D}webhooks${R}\n"
  printf "  ${Y}11a${R} ${D}table${R}          ${Y}30b${R} ${D}iotop${R}          ${Y}40b${R} ${D}oci-mail${R}       ${Y}52${R} ${D}commands${R}\n"
  printf "  ${Y}11b${R} ${D}help${R}           ${Y}30c${R} ${D}top-batch${R}      ${Y}40c${R} ${D}oci-analytics${R}\n"
  printf "  ${Y}12${R}  ${D}info${R}           ${Y}31${R} ${D}sysstat${R}         ${Y}40d${R} ${D}oci-apps${R}\n"
  printf "  ${Y}12a${R} ${D}info${R}           ${Y}31a${R} ${D}iostat${R}         ${Y}40e${R} ${D}gcp-t4${R}\n"
  printf "  ${Y}12b${R} ${D}engines${R}        ${Y}31b${R} ${D}mpstat${R}         ${Y}40f${R} ${D}orchestrate${R}\n"
  printf "  ${Y}20${R}  ${D}deb${R}            ${Y}31c${R} ${D}pidstat${R}        ${Y}40g${R} ${D}local${R}\n"
  printf "  ${Y}20a${R} ${D}nix-cli${R}        ${Y}31d${R} ${D}sar${R}            ${Y}40h${R} ${D}desktop${R}\n"
  printf "  ${Y}20b${R} ${D}nix-gui${R}        ${Y}32${R} ${D}journal-dash${R}    ${Y}40i${R} ${D}vps-cloud${R}\n"
  printf "  ${Y}20c${R} ${D}nix-tty${R}        ${Y}32a${R} ${D}transport${R}      ${Y}40j${R} ${D}gh-actions${R}\n"
  printf "  ${Y}20d${R} ${D}apt-cli${R}        ${Y}32b${R} ${D}priority${R}       ${Y}40k${R} ${D}gh-repos${R}\n"
  printf "  ${Y}20e${R} ${D}apt-gui${R}        ${Y}32c${R} ${D}unit${R}           ${Y}40l${R} ${D}gh-registry${R}\n"
  printf "  ${Y}20f${R} ${D}apt-tty${R}        ${Y}32d${R} ${D}watch-n35${R}      ${Y}41${R}  ${D}ssh${R}\n"
  printf "  ${Y}21${R}  ${D}nixos${R}          ${Y}33${R} ${D}connect${R}         ${Y}41a${R} ${D}gcp-proxy${R}\n"
  printf "  ${Y}21a${R} ${D}hm-cli${R}         ${Y}34${R} ${D}btop-dash${R}       ${Y}41b${R} ${D}oci-mail${R}\n"
  printf "  ${Y}21b${R} ${D}hm-gui${R}         ${Y}35${R} ${D}journal-dash${R}    ${Y}41c${R} ${D}oci-analytics${R}\n"
  printf "  ${Y}21c${R} ${D}hm-tty${R}         ${Y}36${R} ${D}docker-stats${R}    ${Y}41d${R} ${D}oci-apps${R}\n"
  printf "  ${Y}22${R}  ${D}shell${R}                               ${Y}41e${R} ${D}gcp-t4${R}\n"
  printf "  ${Y}22a${R} ${D}fish+tools${R}                          ${Y}41f${R} ${D}github${R}\n"
  printf "  ${Y}22b${R} ${D}fish${R}\n"
  printf "  ${Y}22c${R} ${D}gcl-https${R}\n"
  printf "  ${Y}22d${R} ${D}gcl-ssh${R}\n"
  printf "  ${Y}22e${R} ${D}konsole-cfg${R}\n"
  printf "  ${D}──────────────────────────────────────────────────────────────────────────────────${R}\n"
