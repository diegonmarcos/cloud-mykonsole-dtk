...
show_menu_header() { set +x 2>/dev/null
  ...
  printf "  ${D}12  cmds 120-1225  20b nix-gui      30b iotop          40b oci-mail     51a table${R}\n"
  printf "  ${D}                   20c nix-tty      30c top-batch      40c oci-analy    51b help${R}\n"
  printf "  ${D}                   20d apt-cli      31  sysstat        40d oci-apps     52  info${R}\n"
  printf "  ${D}                   20e apt-gui      31a iostat         40e gcp-t4       52a info${R}\n"
  printf "  ${D}                   20f apt-tty      31b mpstat         40f orchestrate  52b engines${R}\n"
  printf "  ${D}                   21  nixos        31c pidstat        40g local${R}\n"
  printf "  ${D}                   21a hm-cli       31d sar            40h desktop${R}\n"
  printf "  ${D}                   21b hm-gui       32  journal-dash   40i vps-cloud${R}\n"
  printf "  ${D}                   21c hm-tty       32a transport      40j gh-actions${R}\n"
  printf "  ${D}                   22  shell        32b priority       40k gh-repos${R}\n"
  printf "  ${D}                   22a fish+tools   32c unit           40l gh-registry${R}\n"
  printf "  ${D}                   22b fish         32d watch-n35      41  ssh${R}\n"
  printf "  ${D}                   22c konsole-cfg  33  connect        41a gcp-proxy${R}\n"
  printf "  ${D}                   23  git          34  btop-dash      41b oci-mail${R}\n"
  printf "  ${D}                   23a gcl-https    35  journal-dash   41c oci-analy${R}\n"
  printf "  ${D}                   23b gcl-ssh      36  docker-stats   41d oci-apps${R}\n"
  printf "  ${D}                                                       41e gcp-t4${R}\n"
  printf "  ${D}                                                       41f github${R}\n"
  printf "  ${D}──────────────────────────────────────────────────────────────────────────────────${R}\n"
